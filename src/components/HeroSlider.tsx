...
export function HeroSlider() {
  ...
  return (
    <section ref={root} className="ff-hero relative min-h-screen overflow-hidden bg-[#043f4f] text-white">
      <Swiper
            ...
            <div className="relative min-h-screen">
              ...
              <div className="section-shell relative flex min-h-screen items-center pt-20">
                <div className="max-w-4xl pb-12">
                  ...
                  <p className="hero-word hero-copy-shadow mt-6 max-w-2xl text-base leading-8 text-white/92 md:text-lg">{pick(slide.subtitle)}</p>
